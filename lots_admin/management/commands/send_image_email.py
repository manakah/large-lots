...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for application in applications:
            ...
            sent_emails = ['3', '4', '5', '6', '7', '8', '9', '20', '34', '10', '11', '15', '16', '17', '18', '21']
            first_ward = wards[0]
            try:
                second_ward = wards[1]
            except:
            ...
            if application.deed_image == '' and '22' in wards and first_ward not in sent_emails and second_ward not in sent_emails:
